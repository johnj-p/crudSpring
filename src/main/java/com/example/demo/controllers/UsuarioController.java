...
public class UsuarioController {
    ...
    @CrossOrigin
    @GetMapping("/query")        // trae los usuarios con determinado precio
    public ArrayList<UsuarioModel> obtenerUsuarioPorPrecio(@RequestParam("precio") Integer precio){
        return this.usuarioService.obtenerPorPrecio(precio);
    }
    @CrossOrigin
