...
document.getElementById("txtDni").value = parts[1][1]
document.getElementById("txtNombre").value = parts[2][1]
document.getElementById("txtApellido").value = parts[3][1]
document.getElementById("txtEmail").value = parts[4][1]
document.getElementById("txtLocalidad").value = parts[5][1]
