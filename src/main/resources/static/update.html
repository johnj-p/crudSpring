...
<body>
    <main style="margin: 1% 20%;">
        <div class="container">
            <h1>Modificacion Usuarios</h1>
            <form >
                <div class="mb-3">
                    <label for="txtId">#Ticket</label>
                    <input type="text" class="form-control" name="txtId" id="txtId" disabled  ><br>
                </div>
                <div class="mb-3">
                    <label for="txtDni">DNI</label>
                    <input type="text" class="form-control" name="txtDni" id="txtDni"><br>
                </div>     
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="txtApellido" id="txtApellido"><br>
                </div>                
                <div class="mb-3">
                    <label for="txtEmail">Email:</label>
                    <input type="text" class="form-control" name="txtEmail" id="txtEmail"> <br>
                </div>
                <div class="mb-3">
                ...
                <button  type="button"  class="btn btn-success" onclick="modificar()">Confirmar</button>
            </form>
            <br>
